...
func ReconcileConfig(config *corev1.ConfigMap,
	...
	kasConfig := generateConfig(p, version, auditEnabled)
...
func generateConfig(p KubeAPIServerConfigParams, version semver.Version, auditEnabled bool) *kcpv1.KubeAPIServerConfig {
